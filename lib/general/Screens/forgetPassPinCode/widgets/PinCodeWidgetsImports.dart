...
part 'BuildForgetPassPinCode.dart';
part 'BuildPinCodeButton.dart';
part 'BuildForgetPassPinCodeImage.dart';
part 'BuildForgetPassPinCodeText.dart';
part 'BuildResendCode.dart';